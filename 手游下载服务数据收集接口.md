...
POST  `/service/checkAppUpdate.php`
...
```
errorCode=92001&errorMsg=连接版本更新服务器失败&appid=5012&openid=1-11122&totaltime=50&platform=1&ver_addr=www.update.com&version=1.0.1&build=100&check_update=1&updateType=1&versionType=1
```
...
POST  `/service/downloadEvent.php`
